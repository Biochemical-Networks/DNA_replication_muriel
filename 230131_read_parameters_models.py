...
lines = ["./Documents/programming/DNA_replication_muriel/No_abs"] #name of compiled code you want to run, lines = ["./{code_name}"]

#read parameter file, with open('{parameter_file}' as f:)
with open('Documents/programming/DNA_replication_muriel/parameter_files/No_abs_MB1_x1_parameters') as f: 
