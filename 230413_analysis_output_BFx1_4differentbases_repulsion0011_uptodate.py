...
if plot1 ==True:
    ...
    all_steps = True
    # DIR = "230414output"
    L_DIR = ["230517_equi_output","230517output"]
    ...
    date_options = ["2023517","2023518", "2023519", "2023524"]
    ...
    for k, model in enumerate(L_models):
        for repulsion in L_repulsion:
            ...
            for j, base in enumerate(base_combinations):
                ...
                if number_tables ==3:
                    graph_error_g_bb_3tables(L_delta_g_bb_graph, L_epsilon_mean, L_models_titles[k], base, L_epsilon_std_high, L_epsilon_std_low, color_list[j*30],repulsion, OH_matrix, bases_pur1py1pur2py2[j],j,graph,table1,table2,table3)
