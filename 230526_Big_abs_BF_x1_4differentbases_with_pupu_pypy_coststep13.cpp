...
std::vector<int> base_OH_groups(int base){
    ...
    if(base == 1){
        ...
        //base = 2 means, base is iG.
        OH_groups = {1, 1, 0};
    }
    else if(base == 6){
        //base = 1 means, base is iC.
        OH_groups = {0, 0, 1};
    }
    else if(base == 7){
        //base = 1 means, base is S.
        OH_groups = {0, 0, 0};
    }
    else if(base == 8){
        //base = 2 means, base is L.
        OH_groups = {1, 1, 1};
    }
    else if(base == 9){
        //base = 1 means, base is Lambda.
        OH_groups = {1, 1, 1};
    }
    else if(base == 10){
        //base = 1 means, base is Sigma.
        OH_groups = {0, 0, 0};
    }
    else if(base == 11){
        //base = 1 means, base is delta.
        OH_groups = {1, 0, 0};
    }
    else if(base == 12){
        //base = 1 means, base is beta.
        OH_groups = {0, 1, 1};
    }
    else if(base == 13){
        //base = 1 means, base is X.
        OH_groups = {0, 1, 0};
    }
    else if(base == 14){
        //base = 1 means, base is K.
        OH_groups = {1, 0, 1};
    }
    return OH_groups;
}
...
std::vector<int> template_string(std::mt19937 generator, int string_length, vector<double> ratio_bases_template, int purine_1, int purine_2, int pyrimidines_1, int pyrimidines_2){
...
string declare_polymers_string(string date_now, bool all_steps, string DIR, string x_def, string purine_1, string pyrimidines_1, string purine_2, string pyrimidines_2, vector<double> ratio, double repulsion_same_base, double delta_g_pol){
    int rounded_ratio_0 = round(ratio[0]);
    string rounded_ratio_0_str = std::to_string(rounded_ratio_0);
    int rounded_ratio_1 = round(ratio[1]);
    string rounded_ratio_1_str = std::to_string(rounded_ratio_1);
...
string declare_template_string(string date_now, bool all_steps, string DIR, string x_def, string purine_1, string pyrimidines_1, string purine_2, string pyrimidines_2, vector<double> ratio, double repulsion_same_base, double delta_g_pol){
    int rounded_ratio_0 = round(ratio[0]);
    string rounded_ratio_0_str = std::to_string(rounded_ratio_0);
    int rounded_ratio_1 = round(ratio[1]);
    string rounded_ratio_1_str = std::to_string(rounded_ratio_1);
    ...
    string filename_output = "";
    string path = "/home/ipausers/louman/Documents/programming/DNA_replication_muriel/outs/" + DIR + "/";
    filename_output = path + date_now + "template_strings_model_muriel_big_abs_BF_x" + x_def + purine_1 + pyrimidines_1 + purine_2 + pyrimidines_2 + rounded_ratio_0_str + rounded_ratio_1_str + rounded_ratio_2_str + rounded_ratio_3_str  + "_delta_g_pol_" + str_rounded_delta_g_pol + "_repulsion" + rounded_repulsion_str +"_allsteps.csv";
    return filename_output;
}
...
int random_base(double random_number, int purine_1_int, int purine_2_int, int pyrimidine_1_int, int pyrimidine_2_int){
    int random_base = 0;
...
int main(int ac, char* av[]){
    ...
    // string purine_1 = "aA";
    // string purine_2 = "Lambda";
    // string pyrimidines_1 = "T";
    // string pyrimidines_2 =  "Sigma";
    // double repulsion_00_11 = 2;
    ...
    for (double delta_g_pol : L_delta_g_pol){
        ...
        for (step = 0; step <= number_steps; step += 1) {
            ...
            // std::vector<int> mRNA_template = template_string(generator, length_mRNA, ratio_bases_template, purine_1_int, purine_2_int, pyrimidines_1_int, pyrimidines_2_int);
            ...
            int random_base_1 = 0;
            int random_base_2 = 0;
            random_base_1 = random_base(random_number6,purine_1_int, purine_2_int, pyrimidines_1_int, pyrimidines_2_int);
            random_base_2 = random_base(random_number7,purine_1_int, purine_2_int, pyrimidines_1_int, pyrimidines_2_int);
            ...
            if(multiple_DNA == true){
                fstream fss;
                string out_file_strings = declare_polymers_string(date_now,multiple_DNA, DIR, x_def, purine_1, pyrimidines_1, purine_2, pyrimidines_2, ratio_bases_template, repulsion_00_11, delta_g_pol);
            ...
            if(csv_template_string == true){
                fstream fss;
                string out_file_strings = declare_template_string(date_now,multiple_DNA, DIR, x_def, purine_1, pyrimidines_1, purine_2, pyrimidines_2, ratio_bases_template, repulsion_00_11, delta_g_pol);
                fss.open(out_file_strings.c_str(), ios::out | ios::app);
